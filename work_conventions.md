...
- One task == one branch
- Merge all changes from your branches first to dev then to main with pull requests (requires at least 1 approval)
- When starting work check if your local repo is up to date with origin
- Verify that the application builds and runs as intended before creating pull requests or merging
...
Use clear and consistent commit messages based on conventional commit style.
